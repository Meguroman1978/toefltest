...
const HomeScreen: React.FC<HomeScreenProps> = ({ onStart, onShowPastReports, isLoading }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-indigo-900 via-slate-900 to-black flex items-center justify-center p-4 font-sans">
        <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-5 pointer-events-none"></div>

      <div className="max-w-6xl w-full bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl relative z-10" style={{ height: '90vh', maxHeight: '850px', display: 'flex', flexDirection: 'row' }}>
        ...
        <div className="bg-white relative" style={{ width: '66.667%', display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'auto', padding: '2rem' }}>
