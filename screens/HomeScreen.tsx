...
const HomeScreen: React.FC<HomeScreenProps> = ({ onStart, onShowPastReports, isLoading }) => {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl w-full flex flex-col lg:flex-row bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden relative z-10" style={{ height: '85vh', maxHeight: '900px' }}>
        
        {/* Left Side: Dashboard */}
        <div className="lg:w-4/12 bg-slate-100 flex flex-col border-r border-slate-200" style={{ height: '100%' }}>
          ...
          <div className="px-8 pb-8 space-y-3 sidebar-scroll" style={{ flex: '1 1 0', minHeight: 0 }}>
